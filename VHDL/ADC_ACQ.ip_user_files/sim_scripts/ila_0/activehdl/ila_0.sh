...
#
# Generated by Vivado on Thu Jan 06 15:34:50 +0100 2022
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/TORTOISE_DORN/ADC_ACQ_lvds_dispatch_sim_post_implementation/VHDL/ADC_ACQ.cache/compile_simlib/activehdl"
  fi
